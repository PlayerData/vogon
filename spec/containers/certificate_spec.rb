...
RSpec.describe Vogon::Containers::Certificate do
  it "converts to der" do
    ...
    vogon_cert = Vogon::Containers::Certificate.new(
    ...
    expect(vogon_cert.to_der).to eq example_asn.to_der
  end

  it "converts to pem" do
    expect(
      Vogon::Containers::Certificate.from_bytes(File.read(fixture("ca.crt"))).to_pem
